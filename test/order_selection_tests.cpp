...
namespace eoptest {
  ...
  void expect_select_0_3(const vector<int>& numbers, size_t expected_index) {
    const int& r = eop::select_0_3(numbers[0], numbers[1], numbers[2], std::less<int>());
  ...
  void expect_select_1_3(const vector<int>& numbers, size_t expected_index) {
    const int& r = eop::select_1_3(numbers[0], numbers[1],
      numbers[2], std::less<int>());
    EXPECT_EQ(&numbers[expected_index], &r) << to_string(numbers);
  }

  void expect_select_2_3(const vector<int>& numbers, size_t expected_index) {
    const int& r = eop::select_2_3(numbers[0], numbers[1], numbers[2], std::less<int>());
    EXPECT_EQ(&numbers[expected_index], &r) << to_string(numbers);
  }
  ...
  void expect_select_1_4(const vector<int>& numbers, size_t expected_index) {
    ...
    const int& r = eop::select_1_4(numbers[0], numbers[1], numbers[2], numbers[3], std::less<int>());
  ...
  void expect_median_5(const vector<int>& numbers, size_t expected_index) {
    ...
    const int& r = eop::median_5(numbers[0], numbers[1], numbers[2], numbers[3], numbers[4], std::less<int>());
  ...
  TEST(orderselectiontest, testselect02)
  {
    int a = 2;
    int b = 3;
    int r_0 = eop::select_0_2(a, b,std::less<int>());
    EXPECT_EQ(2, r_0);
    
    a = 3;
    const int& r_1 = eop::select_0_2(a, b,std::less<int>());
    EXPECT_EQ(&a, &r_1);
    EXPECT_NE(&b, &r_1);

    a = -10;
    b = 3;
    int r_2 = eop::select_0_2(a, b,std::less<int>());
    EXPECT_EQ(-10, r_2);
  }
  ...
  TEST(orderselectiontest, testselect12)
  {
    int a = 2;
    int b = 3;
    int r_0 = eop::select_1_2(a, b,std::less<int>());
    EXPECT_EQ(3, r_0);

    a = 3;
    const int& r_1 = eop::select_1_2(a, b,std::less<int>());
    EXPECT_NE(&a, &r_1);
    EXPECT_EQ(&b, &r_1);
  }
